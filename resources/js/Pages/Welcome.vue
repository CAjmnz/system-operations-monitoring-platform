...
const submitLogin = () => {
    loginForm.post(route('login.post'), {
...
<div class="min-h-screen bg-gray-100 dark:bg-gray-900 flex flex-col">
    ...
    <div class="relative flex-1 flex items-center justify-center px-6 overflow-hidden">
        ...
        <div class="relative z-10 text-center max-w-3xl">
            <h1 class="text-4xl font-bold text-black-800 dark:text-white">What is SOMP?</h1>
            ...
            <div class="mt-10 flex justify-center space-x-4">
                <!-- CHANGED: now a button, not a Link -->
                <button
...
>
    <div class="bg-white/20 backdrop-blur-xl border border-white/30 p-6 rounded-2xl w-96 shadow-2xl text-white">
        ...
        <button @click="showLogin = false" class="mt-2 text-sm text-white/80">Close</button>
    </div>
</div>
...
>
    <div class="bg-white/20 backdrop-blur-xl border border-white/30 p-6 rounded-2xl w-96 shadow-2xl text-white">
        ...
        <button @click="showRegister = false" class="mt-2 text-sm text-white/80">Close</button>
    </div>
</div>
</template>
